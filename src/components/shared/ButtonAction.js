...
function ButtonAction({user,id,onClickReply}) {

    const[modalIsVisible,setModalVisible] = useState("notVisible");
    const handleDeleteClick = () => modalIsVisible === "notVisible"?setModalVisible("visible"):setModalVisible("notVisible");
    ...
    return ( 
        <div className="btns">                        
            ...
            <Modal
                id={id}
                classModal={`${modalIsVisible==="notVisible"? "":"modal-visible"}`}
